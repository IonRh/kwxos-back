...
(function() {
    ...
    const download_url_us = [
        ...
        ['https://gproxy.isoca.pp.ua/https://github.com/', '自建加速', '[自建加速]'],
    ], clone_url = [
        ['https://gproxy.isoca.pp.ua/https://github.com/', '自建加速', '[自建加速]'],
        ...
        ['https://gproxy.isoca.pp.ua/https://raw.githubusercontent.com', '自建加速', '[自建加速]'],
    ...
    function get_New_download_url() {
        ...
        let shuffled = download_url_us.slice(0), i = download_url_us.length, min = i-1, temp, index;
